    ...
    <footer>
      ...
      <div className='row m0 social-links'>
        <ul className='nav'>
          ...
          <li className='wow fadeInUp' data-wow-delay='0.2s'><a title='LinkedIn' href='https://www.linkedin.com/in/michaelstark5652' target='_blank'><i className='fa fa-linkedin'></i></a></li>
        </ul>
      </div>
